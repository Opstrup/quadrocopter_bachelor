...
Hovedforløb				&
									...
									\begin{enumerate}[topsep=0.0cm, leftmargin=0.5cm]
										...
										\item Bruger er online på webapplikation og giver accept af billedet.
											...
											\end{enumerate}
										\item Drone flyver til næste GPS- eller udgangsposition.
									\end{enumerate} \\\hline	
									...
									\begin{enumerate}[topsep=0.0cm,leftmargin=0.5cm]
										\item Bruger accepterer ikke billede.
											\begin{enumerate}[topsep=0cm, leftmargin=1cm]
												\item Drone instrueres til at ændre højde, orientering eller position. Trin 1-3 i main succes scenario gentages.
											\end{enumerate}
										\item Bruger svarer ikke inden for tidsgrænsen.
											\begin{enumerate}[topsep=0cm, leftmargin=1cm]

...
På domain modellen vises det, at bruger kommunikerer med dronen gennem en website. Websiden har forbindelse til en server som gør instruktioner til main controller tilgængelige. Det vises desuden at kommunikation mellem server og main controller går gennem det mobile 3G netværk. Under flyvning styrer main controlleren både kamera, GPS, afstandssensorer og dronens motorer. 
...
Domain modellen bruges både i beskrivelsen af systemets hardware og software arkitektur. Men der gøres primært brug domain modellen i software arkitektur afsnittet. I software afsnittet bruges domain modellens klasser bla. til at danne grundlag for systemets softwareklasser, klassenavne og klassernes indbyrdes forhold.

...
På domain modellen vises det, at bruger kommunikerer med dronen gennem en website. Websiden har forbindelse til en server som videresender instruktioner til main controller. Det vises desuden at kommunikation mellem server og main controller går gennem det mobile 3G netværk. Under flyvning styrer main controlleren både kamera, GPS, afstandssensorer og dronens motorer. 
...
Domain modellen bruges ikke i beskrivelsen af systemets hardware arkitektur. Men i det afsnit hvor systemets software arkitektur beskrives gøres stor brug af domain modellen. I software afsnittet bruges domain modellens klasser bla. til at danne grundlag for systemets softwareklasser, klassenavne og klassernes indbyrdes forhold.

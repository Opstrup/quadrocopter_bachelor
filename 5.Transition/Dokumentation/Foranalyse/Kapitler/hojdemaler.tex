...
\begin{figure}[H]
\centering
\includegraphics[width=0.3\textwidth]{Billeder/Afstandsmåler/ultra_sensor.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.3\textwidth]{Billeder/Afstandsmåler/ir_sensor.png}
\label{fig:ir_sensor}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.3\textwidth]{Billeder/Afstandsmåler/laser_sensor.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{Billeder/Afstandsmåler/ultra_schematic.png}
\caption{HC-SR04}
\label{fig:HC-SR04}
\end{figure}

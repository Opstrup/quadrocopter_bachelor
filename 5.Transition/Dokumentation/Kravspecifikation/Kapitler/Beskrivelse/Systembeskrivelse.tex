...
Via GPS finder dronen frem til egen position og hvilken retning den skal flyve i. Under flyvningen tager dronen billeder eller optager video, som via nettet overføres til en database der er tilknyttet webapplikationen.
